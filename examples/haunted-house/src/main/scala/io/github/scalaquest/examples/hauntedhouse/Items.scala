...
import io.github.scalaquest.examples.hauntedhouse.House.{kitchen, livingRoom}
import io.github.scalaquest.examples.hauntedhouse.Messages.SuperStonksPowered
