...
import io.github.scalaquest.core.model.behaviorBased.common.groundBehaviors.impl.Navigation
 ...
 */
trait CommonGroundBehaviorsImpl extends CommonBase with Navigation
