...
object Statement {
  ...
  final case class Transitive(action: Action, mainItem: Model#I)                         extends Statement
  final case class Ditransitive(action: Action, mainItem: Model#I, sideItem: Model#Item) extends Statement
}
