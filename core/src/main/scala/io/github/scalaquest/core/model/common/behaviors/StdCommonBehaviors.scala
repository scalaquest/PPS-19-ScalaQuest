...
import io.github.scalaquest.core.model.common.behaviors.std.{Eatable, Openable, RoomLink, Takeable}
 ...
 */
trait StdCommonBehaviors extends StdCommonBehaviorsBase with Takeable with Eatable with Openable with RoomLink
