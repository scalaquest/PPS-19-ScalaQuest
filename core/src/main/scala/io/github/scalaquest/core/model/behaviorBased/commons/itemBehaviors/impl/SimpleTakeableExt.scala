...
import io.github.scalaquest.core.model.behaviorBased.commons.itemBehaviors.{
  CommonItemBehaviorsExt,
  CommonSimpleItemBehaviorsExt
}
import monocle.Lens

/**
 * The trait makes possible to mix into the [[CommonSimpleItemBehaviorsExt]] the standard
 * implementation of [[CommonItemBehaviorsExt.Takeable]].
 */
