...
import io.github.scalaquest.core.model.behaviorBased.common.groundBehaviors.impl.SimpleNavigation
 ...
 */
trait SimpleCommonGroundBehaviors extends CommonBase with SimpleNavigation
