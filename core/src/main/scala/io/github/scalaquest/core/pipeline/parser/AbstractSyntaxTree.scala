...
object AbstractSyntaxTree {
   ...
   * @param verb the intransitive verb
   * @param subject the subject of the verbal predicate
   */
   ...
   * @param verb the transitive verb
   * @param subject the subject of the verbal predicate
   * @param obj the object of the verbal predicate
   */
   ...
   * @param verb the ditransitive verb
   * @param subject the subject of the verbal predicate
   * @param directObj the direct object of the verbal predicate
   * @param indirectObj the indirect object of the verbal predicate
   */
